...
async function harness(){
 ...
 const native=module.exports.nativeDiscussions({extensionPath:'/extension',subscriptions:[],workspaceState:{get:(key)=>key==='nativeDiscussions'?[]:undefined,update:async(key,records)=>{if(key==='nativeDiscussions')saved=JSON.parse(JSON.stringify(records));}}});
